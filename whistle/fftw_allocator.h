...
class fftwf_allocator {
  public:
    ...
    template <class U> constexpr fftwf_allocator(const fftwf_allocator<U>&) noexcept {}
...
bool operator==(const fftwf_allocator<T>&, const fftwf_allocator<U>&) { return true; }
template <class T, class U>
bool operator!=(const fftwf_allocator<T>&, const fftwf_allocator<U>&) { return false; }
